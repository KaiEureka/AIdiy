...
前置知识：[抽象代数基本概念](基础.md)、[置换与排列](../permutation.md)
...
![同态基本定理的交换图](../../Attachment/pictures/images/homomorphism.svg)
...
这一定理在组合数学中有很多用处，可以用于统计「本质不同」的对象的数目。更多例子和讨论可以参考 [Pólya 计数](../组合数学/polya.md)。
